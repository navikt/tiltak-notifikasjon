...
class FakeFakeUnleash : Unleash {
    ...
    override fun isEnabled(
        ...
        biPredicate: BiPredicate<String, UnleashContext>
    ): Boolean {
        return if (features.containsKey(toggleName)) {
            features[toggleName]!!
        } else if (enableAll) {
            ...
            biPredicate.test(toggleName, unleashContext)
        }
    }
    ...
    override fun getVariant(toggleName: String, unleashContext: UnleashContext, defaultValue: Variant): Variant {
    ...
    override fun more(): MoreOperations {
        throw UnsupportedOperationException("More operations are not supported")
    }
