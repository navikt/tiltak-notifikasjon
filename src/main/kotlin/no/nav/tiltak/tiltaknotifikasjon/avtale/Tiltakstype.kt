...
enum class Tiltakstype(val beskrivelse: String, val arbeidsgiverNotifikasjonMerkelapp: String, val ressursId: String) {
    ...
    FIREARIG_LONNSTILSKUDD(beskrivelse = "Fireårig lønnstilskudd for unge", arbeidsgiverNotifikasjonMerkelapp = "Lønnstilskudd", ressursId = "nav_tiltak_firearig-lonnstilskudd")
}
